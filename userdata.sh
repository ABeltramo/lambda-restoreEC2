...
/usr/bin/docker run --name CopiaIncollaDB -v /mnt/DATA/mysql/:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=alepollo93! -d -p 3306:3306 --restart=always mysql/mysql-server:5.5 --lower_case_table_names=1
